...
| `unmapped`, our side | 13 | 13 | 15 | The 11 specialization-cycle rows (F4/K5) plus the two metadata name-conflict diagnostics F64b unmasked — a deliberate one-sided check of ours (F69), not a new one. |
