...
| **Total** | **353** | **317** | **168** | **122** | **25** | **24** | **119** | **73** |
...
reference corpora is 47. `severity-only` (24) and only-pilot (**73**) are unmoved for the same reason:
