...
## Results (pilot `2026-07`, 365 files)
...
| `examples` | 31 | 22 | 2 | 35 | 0 | 1 | 1 | 34 |
| `cmd/pilot-diff/testdata` (probes) | 4 | 1 | 6 | 0 | 0 | 0 | 6 | 0 |
| **Total** | **365** | **335** | **56** | **96** | **34** | **2** | **20** | **60** |
...
`examples` 10 syntax, 18 `unmapped`, 5 `kind-mismatch`, 1 `unresolved-reference` — of which
