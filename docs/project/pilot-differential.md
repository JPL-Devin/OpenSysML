...
| `examples` | 32 | 25 | 2 | 277 | 0 | 1 | 1 | 276 |
| `cmd/pilot-diff/testdata` (probes) | 4 | 1 | 6 | 0 | 0 | 0 | 6 | 0 |
| **Total** | **366** | **338** | **56** | **338** | **34** | **2** | **20** | **302** |
...
| overall: pilot diagnostics | 347 | **338** |
| `examples`: agreed diagnostics | 9 | **0** |
| `examples`: our diagnostics | 11 | **2** |
| `examples`: pilot diagnostics | 286 | **277** |
