...
| `examples/pilot-corpora/sysml-examples` | 98 | 83 | 68 | 0 | 0 | 0 | 68 | 0 |
| `examples/pilot-corpora/sysml-validation` | 56 | 52 | 10 | 0 | 0 | 0 | 10 | 0 |
| `examples/pilot-corpora/kerml-examples` | 58 | 50 | 4 | 6 | 0 | 0 | 4 | 6 |
| `testdata` | 15 | 8 | 29 | 53 | 23 | 3 | 3 | 27 |
| `examples` | 22 | 15 | 40 | 64 | 0 | 12 | 28 | 52 |
| `cmd/pilot-diff/testdata` (probes) | 4 | 1 | 6 | 0 | 0 | 0 | 6 | 0 |
| **Total** | **353** | **309** | **157** | **123** | **23** | **15** | **119** | **85** |

This table is a clean full run on `main` at `8faed39a`, with wave 9 merged — #450 (9A implicit
...
Per category, the only-ours totals are: `pilot-examples` 31 syntax, 27
`unresolved-reference`, 5 `unmapped`, 4 `kind-mismatch`, 1 `units`; `pilot-validation` 7
syntax, 2 `kind-mismatch`, 1 `unresolved-reference`; `kerml-examples` 3 `unmapped`, 1
`unresolved-reference`; `examples` 28 syntax; `testdata` 2 `unmapped`, 1
`multiplicity`; `probes` 6 `unmapped`.
Only-pilot: `testdata` 18 `kind-mismatch`, 4 `unmapped`, 3 syntax, 2 `unresolved-reference`;
`examples` 24 syntax, 15 `unmapped`, 6 `kind-mismatch`, 5 `unresolved-reference`, 2
