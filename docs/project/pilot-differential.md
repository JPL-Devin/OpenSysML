...
| `examples/pilot-corpora/sysml-examples` | 98 | 87 | 43 | 0 | 0 | 0 | 43 | 0 |
...
| **Total** | **353** | **317** | **175** | **122** | **32** | **24** | **119** | **66** |

**Read the `only ours` total by root, never as one number.** It falls 142 → **119** in wave 11, and
every row of that fall is on the reference's **own** corpora: `pilot-examples` 63 → 43,
`pilot-validation` 3 → 1, `kerml-examples` 4 → 3, so our diagnostics there fall 70 → **47**. The
