...
prints the current ones. State of the 97 committed cases, the original 32, the 62 the
expression round added and the 3 of `contextual_names.cases`:

```
agree: 58 · kind-only: 1 · order-only: 0 · disagree: 1
