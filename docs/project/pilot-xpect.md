...
agree 382 | disagree 713 | unlocated 0 | not adjudicated 231
```

| Kind | Expectations | Agree | Disagree | Not adjudicated | `same-location` | `same-line` | `severity-differs` | `elsewhere` | nothing |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `errors` | 513 | 0 | 513 | 0 | 152 | 70 | 15 | 89 | 187 |
| `noErrors` | 275 | 231 | 44 | 0 | — | — | — | — | — |
| `linkedName` | 194 | 151 | 43 | 0 | — | — | — | — | — |
| `warnings` | 113 | 0 | 113 | 0 | 0 | 0 | 64 | 0 | 49 |
| `scope` | 230 | 0 | 0 | 230 | — | — | — | — | — |
...
|---|---:|---:|---:|---:|---:|
| `kerml` | 303 | 968 | 319 | 418 | 231 |
| `sysml` | 125 | 358 | 63 | 295 | 0 |
...
below group the disagreements by cause and name the files; they do not repeat 713 rows.
