...
the default mode the same corpus gives 195 agreements and 25 gaps, which is what `-conformance
default` prints. `-conformance strict` gives 198 and 22. Reserved keywords recovered as declared
