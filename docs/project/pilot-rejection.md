...
the default mode the same corpus gives 203 agreements and 18 gaps, which is what `-conformance
default` prints. `-conformance strict` gives 205 and 15. Reserved keywords recovered as declared
...
source: 12 named KerML constraints (`k11`–`k42`, `s80`) and 3 named SysML constraints (`s04`,
