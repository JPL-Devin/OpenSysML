...
three trigger-argument typing cases (`s48`–`s50`), and to 235 with the enumerated value typed by
its literal (`p18-enum-value-typed-outside-enumeration`). The KerML constraints in that
