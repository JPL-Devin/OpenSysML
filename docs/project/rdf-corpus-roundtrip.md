...
So 267 of 345 files convert to Turtle, and of those 261 come back as the same graph (194 exactly,
67 up to `sysx:sourceText` whitespace). The refusals by class: 20 `feature-declaration`,
