...
- **What is not mapped is refused, not partly converted**, and the refusal names
  ...
  255, differs as a graph for 8, and 5 cannot be written back or re-read at all.
...
the second hop reproduces the Turtle byte for byte for 255 of the 268 files that
