...
**A head written from the graph comes back in one spelling.** The graph carries
what a head declares, not how it was spelled, so where no stored text is written
— the graph carries none, or its text no longer states what the graph states —
