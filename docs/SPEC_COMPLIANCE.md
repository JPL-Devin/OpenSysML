...
- 2,820 tests and subtests, of which 2,815 pass and 5 skip (`go test -count=1 -v ./...`; 1,545 top-level `Test` functions). The skips are unimplemented-expression and requirement-subject cases that skip themselves.
