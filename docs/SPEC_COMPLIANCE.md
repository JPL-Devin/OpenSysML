...
- 2,819 tests and subtests, of which 2,814 pass and 5 skip (`go test -count=1 -v ./...`; 1,544 top-level `Test` functions). The skips are unimplemented-expression and requirement-subject cases that skip themselves.
