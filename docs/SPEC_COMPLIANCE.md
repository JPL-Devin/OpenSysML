...
- 2,873 tests and subtests, of which 2,868 pass and 5 skip (`go test -race -count=1 -v ./...`; 1,546 top-level `Test` functions). The skips are unimplemented-expression and requirement-subject cases that skip themselves.
