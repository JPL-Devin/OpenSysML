...
- 161 runtime unit tests
- 30 golden AST fixtures (including pseudostate, timed-trigger, call-trigger and calc default/invocation parsing tests)
...
- Golden AST fixtures: 30
- Golden execution traces: 22
- Negative parser subtests: 32
