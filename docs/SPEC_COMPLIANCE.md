...
- 2,894 tests and subtests, of which 2,889 pass and 5 skip (`go test -race -count=1 -v ./...`; 1,554 top-level `Test` functions). The skips are unimplemented-expression and requirement-subject cases that skip themselves.
