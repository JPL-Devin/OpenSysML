...
service_pattern='^(api/proto/|cmd/|internal/|client/|conformance/|testdata/|scripts/|examples/|ontology/|editors/vscode/tools/|editors/vscode/syntaxes/|Makefile$|go\.mod$|go\.sum$|buf\.|\.github/workflows/|\.circleci/)'
