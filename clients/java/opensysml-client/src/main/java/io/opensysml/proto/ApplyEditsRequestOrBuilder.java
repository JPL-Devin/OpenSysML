...
public interface ApplyEditsRequestOrBuilder extends
   ...
   */
  java.util.List<io.opensysml.proto.EditOperation> 
      getOperationsList();
  /**
   * <pre>
   * Edits to apply, all of them or none. Empty is rejected: it names no edit,
   ...
   * <code>repeated .sysml.EditOperation operations = 2 [json_name = "operations"];</code>
   */
  io.opensysml.proto.EditOperation getOperations(int index);
  /**
   * <pre>
   * Edits to apply, all of them or none. Empty is rejected: it names no edit,
   * and answering with the unedited source would look like one was made.
   ...
   * <code>repeated .sysml.EditOperation operations = 2 [json_name = "operations"];</code>
   */
  java.util.List<? extends io.opensysml.proto.EditOperationOrBuilder> 
   ...
   * <code>repeated .sysml.EditOperation operations = 2 [json_name = "operations"];</code>
   */
  io.opensysml.proto.EditOperationOrBuilder getOperationsOrBuilder(
      int index);
}
