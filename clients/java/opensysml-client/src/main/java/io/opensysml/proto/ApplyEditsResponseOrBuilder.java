...
public interface ApplyEditsResponseOrBuilder extends
   ...
   */
  java.util.List<io.opensysml.proto.AppliedEdit> 
      getAppliedList();
  /**
   * <pre>
   * What each operation changed, in request order.
   ...
   * <code>repeated .sysml.AppliedEdit applied = 2 [json_name = "applied"];</code>
   */
  io.opensysml.proto.AppliedEdit getApplied(int index);
  /**
   * <pre>
   * What each operation changed, in request order.
   * </pre>
   ...
   * <code>repeated .sysml.AppliedEdit applied = 2 [json_name = "applied"];</code>
   */
  java.util.List<? extends io.opensysml.proto.AppliedEditOrBuilder> 
   ...
   * <code>repeated .sysml.AppliedEdit applied = 2 [json_name = "applied"];</code>
   */
  io.opensysml.proto.AppliedEditOrBuilder getAppliedOrBuilder(
      int index);
   ...
   * @return The failure.
   */
  io.opensysml.proto.EditFailure getFailure();
