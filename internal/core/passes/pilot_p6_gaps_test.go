...
func TestConstraintFlowEndSubsettingNotImplemented(t *testing.T) {
	t.Skip("F21: flow-end subsetting is not checked; see docs/project/pilot-differential.md P6")
...
func TestFilterModelLevelEvaluableFalsePositive(t *testing.T) {
	t.Skip("F22: our filter evaluability is narrower than modelLevelEvaluable; see docs/project/pilot-differential.md P6")
...
func TestFilterModelLevelEvaluableFalseNegative(t *testing.T) {
	t.Skip("F22: a featured feature is not model-level evaluable; see docs/project/pilot-differential.md P6")
...
func TestTypeCheckInvocationInstantiatedTypeNotImplemented(t *testing.T) {
	t.Skip("F23: the invoked declaration's kind is not checked; see docs/project/pilot-differential.md P6")

	const src = `package C {
	part def Widget;
	part w = Widget();
}`
	if !hasCode(constraintDiags(t, src), "invocation-not-behavior") {
