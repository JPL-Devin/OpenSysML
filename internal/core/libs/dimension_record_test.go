...
func TestDimensionFactsRoundTrip(t *testing.T) {
	rec := IndexRecord{Symbols: []symRecord{
		{FQN: "Dimensionless", Dimension: &symbols.DimensionFacts{}},
		{FQN: "Length", Dimension: &symbols.DimensionFacts{
			Factors: []symbols.DimensionFactorFacts{{FQN: "ISQBase::length", Exponent: 1}},
		}},
		{FQN: "Undetermined"},
	}}
