...
**Measured status:** of the 676 semantic rules tracked in [spec compliance](docs/project/spec-compliance.md), 595 are ✅ faithful, 71 ⚠️ approximate and 10 ❌ not implemented. That denominator is our own list of rules, not the specification's, so it is a progress measure and not a compliance percentage.
