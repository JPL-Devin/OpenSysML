...
**Measured status:** of the 673 semantic rules tracked in [spec compliance](docs/project/spec-compliance.md), 596 are ✅ faithful, 68 ⚠️ approximate and 9 ❌ not implemented. That denominator is our own list of rules, not the specification's, so it is a progress measure and not a compliance percentage.
