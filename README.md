...
**Test coverage:** 3,592 tests and subtests (3,587 pass, 5 skip themselves; 1,931 top-level `Test` functions) covering parsers, semantics, runtime (actions, states, instances, operators, validation). Behavioral robustness: 80 golden ASTs, 127 negatives, 211 conformance cases, 69 golden traces, 143 robustness subtests.
