...
**Measured status:** of the 661 semantic rules tracked in [spec compliance](docs/project/spec-compliance.md), 591 are ✅ faithful, 63 ⚠️ approximate, 1 ❌ not implemented and 6 ⛔ a deliberate divergence. That denominator is our own list of rules, not the specification's, so it is a progress measure and not a compliance percentage.
