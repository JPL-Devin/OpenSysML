...
| Behavioral parser (unified grammar with graceful fallback) | ✅ Complete (105 golden ASTs, 167 negative tests) |
...
**Test coverage:** 5,793 tests and subtests (5,779 pass, 14 skip themselves; 3,067 top-level `Test` functions) covering parsers, semantics, runtime (actions, states, instances, operators, validation). Behavioral robustness: 105 golden ASTs, 167 negatives, 344 conformance cases, 109 golden traces, 195 runtime robustness cases and 8 gRPC ones.
