...
**Measured status:** of the 688 semantic rules tracked in [spec compliance](docs/project/spec-compliance.md), 603 are ✅ faithful, 73 ⚠️ approximate and 12 ❌ not implemented. That denominator is our own list of rules, not the specification's, so it is a progress measure and not a compliance percentage.
