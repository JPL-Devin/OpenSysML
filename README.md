...
**Measured status:** of the 652 semantic rules tracked in [spec compliance](docs/project/spec-compliance.md), 569 are ✅ faithful, 76 ⚠️ approximate and 7 ❌ not implemented. That denominator is our own list of rules, not the specification's, so it is a progress measure and not a compliance percentage.
