...
**Measured status:** of the 661 semantic rules tracked in [spec compliance](docs/project/spec-compliance.md), 587 are ✅ faithful, 67 ⚠️ approximate and 7 ❌ not implemented. That denominator is our own list of rules, not the specification's, so it is a progress measure and not a compliance percentage.
