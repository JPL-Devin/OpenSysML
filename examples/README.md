...
| [mars2020-perseverance/perseverance.sysml](mars2020-perseverance/perseverance.sysml) | [mars2020-perseverance/README.md](mars2020-perseverance/README.md) | the Mars 2020 Perseverance rover, end to end: subsystem structure with SI quantities, conjugated ports and interfaces, flows, hierarchical states, sol-plan and sampling actions, requirements with a satisfaction assertion and a verification case, a trade study, an individual mission with a snapshot and a timeslice, and metadata-filtered views |
