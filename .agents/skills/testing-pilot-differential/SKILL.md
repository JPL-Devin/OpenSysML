...
- Measured after closing the library-inherited-name gap, with a fresh library cache: `355 file(s), 327 fully agreeing; 37 agreed,
  28 only ours, 58 only the pilot's`, JSON totals `openSysMLDiagnostics 73 / pilotDiagnostics
...
current: a live run gives `355 file(s), 327 fully agreeing; 37 agreed, 28 only ours, 58 only the
