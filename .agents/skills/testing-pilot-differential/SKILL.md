...
- Measured after wave 10: `353 file(s), 311 fully agreeing; 25 agreed,
  142 only ours, 73 only the pilot's`, JSON totals `openSysMLDiagnostics 191 / pilotDiagnostics
...
but only while the baseline is current. Check that first. As of the wave-10 rebaseline it **is**
current: a live run gives `353 file(s), 311 fully agreeing; 25 agreed, 142 only ours, 73 only the
