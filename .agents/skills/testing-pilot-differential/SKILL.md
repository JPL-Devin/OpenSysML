...
- Measured after wave 11, with a fresh library cache: `353 file(s), 317 fully agreeing; 25 agreed,
  119 only ours, 73 only the pilot's`, JSON totals `openSysMLDiagnostics 168 / pilotDiagnostics
...
but only while the baseline is current. Check that first. As of the wave-11 rebaseline it **is**
current: a live run gives `353 file(s), 317 fully agreeing; 25 agreed, 119 only ours, 73 only the
