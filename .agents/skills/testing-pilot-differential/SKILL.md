...
- Measured after closing the library-inherited-name gap, with a fresh library cache: `357 file(s), 330 fully agreeing; 37 agreed,
  26 only ours, 75 only the pilot's`, JSON totals `openSysMLDiagnostics 71 / pilotDiagnostics
...
current: a live run gives `357 file(s), 330 fully agreeing; 37 agreed, 26 only ours, 75 only the
