...
- Measured after the wave-6 round and 7A (#409, #415, #424): `353 file(s), 300 fully agreeing; 22 agreed,
  147 only ours, 137 only the pilot's`, JSON totals `openSysMLDiagnostics 185 / pilotDiagnostics
...
current: a live run gives `353 file(s), 300 fully agreeing; 22 agreed, 147 only ours, 137 only the
