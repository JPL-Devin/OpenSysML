...
after the self-model accuracy round that is `366 file(s), 334 fully agreeing; 34 agreed diagnostic(s), 20
only ours, 310 only the pilot's`. Read the number out of
