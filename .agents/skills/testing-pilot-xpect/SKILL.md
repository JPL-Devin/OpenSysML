...
after the objective-evaluation round that is `366 file(s), 338 fully agreeing; 34 agreed diagnostic(s), 20
only ours, 302 only the pilot's`. Read the number out of
