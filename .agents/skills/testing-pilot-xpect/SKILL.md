...
after the standard-notation demo round that is `358 file(s), 332 fully agreeing; 34 agreed diagnostic(s), 20
only ours, 50 only the pilot's`. Read the number out of
