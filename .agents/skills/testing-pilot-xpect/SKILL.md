...
after the output-initializer rewrite in `examples/action-executor-demo.sysml` that is `353 file(s),
324 fully agreeing; 32 agreed diagnostic(s), 27 only ours, 61 only the pilot's`. Read the number out of
