...
after the architecture self-model round that is `365 file(s), 335 fully agreeing; 34 agreed diagnostic(s), 20
only ours, 60 only the pilot's`. Read the number out of
