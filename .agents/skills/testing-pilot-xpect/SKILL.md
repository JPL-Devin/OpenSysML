...
after the standard-notation demo round that is `357 file(s), 332 fully agreeing; 36 agreed diagnostic(s), 20
only ours, 45 only the pilot's`. Read the number out of
