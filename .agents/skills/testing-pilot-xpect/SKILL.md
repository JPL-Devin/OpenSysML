...
after the Perseverance example round that is `359 file(s), 332 fully agreeing; 34 agreed diagnostic(s), 20
only ours, 52 only the pilot's`. Read the number out of
