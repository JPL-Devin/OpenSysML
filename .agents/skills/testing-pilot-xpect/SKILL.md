...
after the self-model's library-snapshot round that is `366 file(s), 334 fully agreeing; 34 agreed diagnostic(s), 20
only ours, 321 only the pilot's`. Read the number out of
