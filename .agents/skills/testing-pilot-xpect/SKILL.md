...
after the control-node succession pass joined the self-model that is `366 file(s), 334 fully agreeing; 34 agreed diagnostic(s), 20
only ours, 333 only the pilot's`. Read the number out of
