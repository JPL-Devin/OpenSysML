...
after the objective-evaluation round that is `367 file(s), 338 fully agreeing; 34 agreed diagnostic(s), 20
only ours, 572 only the pilot's`. Read the number out of
