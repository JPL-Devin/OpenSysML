...
the headline the committed baseline holds — `367 file(s), 338 fully agreeing; 34 agreed
diagnostic(s), 20 only ours, 572 only the pilot's` after the objective-evaluation round, so read it from
