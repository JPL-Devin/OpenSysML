...
the headline the committed baseline holds — `353 file(s), 325 fully agreeing; 32 agreed
diagnostic(s), 26 only ours, 61 only the pilot's` after the interface-flow pairing fix, so read it from
