...
the headline the committed baseline holds — `353 file(s), 321 fully agreeing; 32 agreed
diagnostic(s), 92 only ours, 66 only the pilot's` after wave 12F, so read it from
