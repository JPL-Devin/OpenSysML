...
the headline the committed baseline holds — `366 file(s), 337 fully agreeing; 43 agreed
diagnostic(s), 20 only ours, 303 only the pilot's` after the feature-value overriding round, so read it from
