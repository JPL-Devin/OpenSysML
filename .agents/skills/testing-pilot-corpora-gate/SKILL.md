...
the headline the committed baseline holds — `367 file(s), 337 fully agreeing; 43 agreed
diagnostic(s), 21 only ours, 572 only the pilot's` after the unbound-parameter round, so read it from
