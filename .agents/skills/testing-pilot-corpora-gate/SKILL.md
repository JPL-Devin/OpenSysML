...
the headline the committed baseline holds — `353 file(s), 297 fully agreeing; 22 agreed
diagnostic(s), 161 only ours, 137 only the pilot's` after the wave-6 rebaseline, so read it from
