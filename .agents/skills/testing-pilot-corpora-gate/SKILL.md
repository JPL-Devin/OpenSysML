...
the headline the committed baseline holds — `365 file(s), 335 fully agreeing; 34 agreed
diagnostic(s), 20 only ours, 60 only the pilot's` after the architecture self-model round, so read it from
