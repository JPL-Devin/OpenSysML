...
| `SYSML_MAX_ELEMENTS` | 1000000 | materialized collection elements (~104 MB of `Value`s), the memory bound: `(1..2000000)` reports `collection element limit exceeded`, not the step limit |
