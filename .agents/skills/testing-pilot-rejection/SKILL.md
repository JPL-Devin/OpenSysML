...
`cmd/pilot-reject/testdata/negative/` (265 hand-written invalid models, one violated rule + citation
...
`265 case(s): 256 both reject, 0 only the pilot rejects, 9 only we reject, 0 both accept`,
