...
`cmd/pilot-reject/testdata/negative/` (256 hand-written invalid models, one violated rule + citation
...
`256 case(s): 247 both reject, 0 only the pilot rejects, 9 only we reject, 0 both accept`,
