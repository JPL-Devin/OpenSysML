...
`cmd/pilot-reject/testdata/negative/` (229 hand-written invalid models, one violated rule + citation
...
succession rules, the feature-value overriding rule and the send-action cases), with a fresh library cache:
