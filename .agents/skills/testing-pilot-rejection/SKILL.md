...
`cmd/pilot-reject/testdata/negative/` (243 hand-written invalid models, one violated rule + citation
...
count and multiplicity-bound typing rules, and the annotation-ownership, binding-arity, feature-chain conformance,
conjugated typing and end-feature rules), with a fresh library cache:
