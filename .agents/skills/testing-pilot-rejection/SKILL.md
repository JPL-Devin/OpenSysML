...
succession rules, the feature-value overriding rule, the enumeration-variation rules and the metadata
typing, annotated-element and body rules), with a fresh library cache:
