...
`cmd/pilot-reject/testdata/negative/` (237 hand-written invalid models, one violated rule + citation
...
the metadata typing, annotated-element and body rules, the trigger-argument typing rules, the owning-body member rules, the cross-subsetting rules, the variant port rule, and the association arity, binary-link end
