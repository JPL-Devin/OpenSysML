...
`cmd/pilot-reject/testdata/negative/` (257 hand-written invalid models, one violated rule + citation
...
`257 case(s): 248 both reject, 0 only the pilot rejects, 9 only we reject, 0 both accept`,
