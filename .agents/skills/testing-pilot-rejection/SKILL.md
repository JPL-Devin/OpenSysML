...
`cmd/pilot-reject/testdata/negative/` (248 hand-written invalid models, one violated rule + citation
...
`248 case(s): 239 both reject, 0 only the pilot rejects, 9 only we reject, 0 both accept`,
