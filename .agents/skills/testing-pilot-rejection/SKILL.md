...
`cmd/pilot-reject/testdata/negative/` (122 hand-written invalid models, one violated rule + citation
...
# as of the send-action rules: 120 agreements, 2 gaps — the numbers strict mode leaves alone
