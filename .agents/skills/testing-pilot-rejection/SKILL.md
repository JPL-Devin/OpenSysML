...
succession rules, the feature-value overriding rule, the enumeration-variation rules and the
feature-variability rules), with a fresh library cache:
...
# as of the `semantic/` source: 197 agreements, 23 gaps — the numbers strict mode leaves alone
