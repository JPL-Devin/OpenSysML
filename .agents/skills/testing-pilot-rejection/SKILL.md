...
succession rules, the feature-value overriding rule, the enumeration-variation rules, the send-action cases and the cross-subsetting rules), with a fresh library cache:
