...
`cmd/pilot-reject/testdata/negative/` (227 hand-written invalid models, one violated rule + citation
...
As of the `semantic/` source (named pilot constraints, KerML and SysML, and the control-node
